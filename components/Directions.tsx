        ...
        <div className=" flex  gap-4">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p>
              ...
              corporis iure suscipit tempora ab, dolorum praesentium ratione
              vel, quisquam delectus quidem, rem et voluptates autem omnis eaque
              unde placeat voluptatibus.
            </p>
            <Image alt="cooking" src={direction} className="w-full" />
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque
              corporis similique quasi eaque recusandae ad. Necessitatibus,
              fugiat, corporis natus cumque eaque magni obcaecati nam illo
              nostrum a aliquid. Ipsum, excepturi.
            </p>
          </div>
        </div>
        <div className="flex gap-4">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p>
              ...
              Repellendus dolor autem commodi earum minima sint iste doloremque
              est molestias cum, vero quisquam reiciendis officiis eius
              perferendis assumenda architecto, necessitatibus inventore.
            </p>
          </div>
        </div>
      </div>
